...
Performed data cleaning and transformation using Power Query, including:

- Handling missing values.
- Removing duplicate records.
- Correcting data types.
- Standardizing data fields.
- Creating analytical date attributes.
...
Developed DAX measures for key business metrics, including:
...
- Q4 contributed the highest revenue share compared with other quarters, indicating strong seasonal demand.
- The Technology category generated the highest sales and profitability across product categories.
